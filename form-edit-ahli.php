        ...
        <div class="col-md-12 mt-5 mb-5">
          <div class="card shadow-sm bg-body rounded">
            <div class="card-header shadow-sm bg-body rounded" style="background-color: white;">
              <div class="card-title ps-3 fw-bold">Form Edit Ahli</div>
            </div>
            <div class="card-body">
              ...
              <div class="row">
                <div class="mb-3 pe-5 ps-5">
                  ...
                  <div class="mb-3 pe-5 ps-5">
                    ...
                    <input type="text" class="form-control" id="jabatan" name="jabatan" value="<?php echo $user_data['jabatan']; ?>">
                  </div>
                  ...
                  <div class="mb-3 pe-5 ps-5">
                    ...
                    <input type="text" class="form-control" id="jam_available" name="jam_available" value="<?php echo $user_data['jam_available']; ?>">
                  </div>
                  ...
                  <div class="mb-3 pe-5 ps-5">
                    ...
                    <input type="file" class="form-control" id="video" name="video" value="<?php echo $user_data['video']; ?>" placeholder="<?php echo $user_data['video']; ?>">
                  </div>
