<?php
    ...
    left join public.user on peternak.id_peternak=public.user.username where pemesanan.status='2' and produk.id_peternak='$username';");
    ...
    <div class="container"style="padding-top:100px;padding-bottom:5%;"> 
        <div class="card text-center">
            <div class="card-header">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="so-pengemasan-peternak.php">Perlu Dikemas</a>
                </li>
                <li class="nav-item">
                ...
                <ul class="list-group list-group-flush">
                    <?php while($data = pg_fetch_object($datas)): ?>
                        ...
                        <br>No.pemesanan: <?=$data->no_pemesanan?>
                            <a class="btn btn-outline-success" href="detail-pengemasan-peternak.php?id=<?=$data->no_pemesanan?>&nama=<?=$data->name?>" style="float:right; role="button">Detail</a>
                        </li>
                    <?php endwhile; ?>   
                </ul>
