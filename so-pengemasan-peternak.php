<?php
    ...
    left join public.user on mitra.id_pemilik=public.user.username where pemesanan.status='2' and produk.id_peternak='$username';");
                ...
                <ul class="list-group list-group-flush">
                    <?php while($data = pg_fetch_object($datas)): ?>
                        ...
                        <br>No.pemesanan: <?=$data->no_pemesanan?>
                            <a class="btn btn-outline-success" href="detail-pengemasan-peternak.php?id=<?=$data->no_pemesanan?>" style="float:right; role="button">Detail</a>
                        </li>
                    <?php endwhile; ?>   
                </ul>
