<?php
    ...
    left join public.user on peternak.id_peternak=public.user.username where pemesanan.status='4' and produk.id_peternak='$username';");
            ...
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                    <?php while($data = pg_fetch_object($datas)): ?>
                        ...
                        <a class="btn btn-outline-success" href="detail-selesai-peternak.php?id=<?=$data->no_pemesanan?>&nama=<?=$data->name?>" style="float:right; role="button">Detail</a>
                        </li>
                    <?php endwhile; ?>   
                </ul>
