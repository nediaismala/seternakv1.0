...
<body>
  ...
  <div class="container-lg mt-5">
    ...
    <form action="function/add-faq.php" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="mb-3 pe-5 ps-5">
                  ...
                  <input type="text" class="form-control" id="id_faq" name="id_faq" value="<?php echo generateRandomString(8); ?>" readonly>
                </div>
