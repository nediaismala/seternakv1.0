...
<head>
  ...
  if (isset($_GET['username'])) {
    $username = $_GET['username'];
    $sql = pg_query("select * from mitra join public.user on mitra.id_pemilik=public.user.username where username='" . $username . "'");
...
<body>
  ...
  <div class="container-lg mt-5">
    ...
    <form action="function/edit-profile-mitra.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-title mt-4  ps-5 form-container ">
                  <div class="d-flex flex-wrap align-items-center ">
                    ...
                    <div class="mb-3 col-lg-6 col-xs-12 me-4 input-wrapper" style="flex: 1;">
                      ...
                      <input type="text" class="form-control" id="id_pemilik" name="id_pemilik" value="<?php echo $user_data['id_pemilik']; ?>">
                    </div>
