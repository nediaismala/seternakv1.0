...
<html lang="en">
  <head>
    ...
    <title>Tambah User/Partner</title>
  </head>
  <body>
    ...
    <div class="container"style="padding-top:100px;padding-bottom:5%;"> 
        <div class="card text-center">
            <div class="card-header">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="true" href="read-user.php">User</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="read-partner.php">Partner</a>
                </li>
                </ul>
            </div>
            <div class="card-body">
