    ...
    <!-- Content -->
        <section class="my-5">
            <div class="container mt-5">
                <form action="order.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col text-start">
                            ...
                            <table class="text-black-50" style="margin-top:10px;">
                                <tr>
                                    <td class="pe-4">Kuatitas</td>
                                    <td class="pe-4">
                                        <div class="number">
                                ...
                                <tr>
                                    <td><a type="submit" name="belisekarang" href="" class="btn btn-success me-2">Beli Sekarang</a></td>
                                    <td><span type="submit" name="keranjang" class="btn btn-success bi bi-cart font-hijau me-2 bold"><a href=""></a></span></td>
                                </tr>
                            </table>
                ...
                <div class="row">
                    <div class="col my-4">
                            <h5 class="fw-bolder text-black-50">Deskripsi Produk</h5><hr>
                            <p><?php echo $pecah['deskripsi_produk']; ?></p>
                            <h5 class="fw-bolder text-black-50 mt-5">Penilaian Produk</h5><hr>
                            <?php 
                            if(isset($pecah2['rate'])){
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span><small class="font-weight-bold text-primary ms-3"><h6 class="fw-bold ms-2 list-inline-item font-hijau"><?php echo $pecah1['rm']; ?></h6></small><br> 
