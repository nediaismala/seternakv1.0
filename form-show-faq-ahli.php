        ...
        <div class="col-md-12 mt-5 mb-5">
          <div class="card shadow-sm bg-body rounded">
            <div class="card-header shadow-sm bg-body rounded" style="background-color: white;">
              <div class="card-title ps-3 fw-bold">Form Detail faq ahli</div>
            </div>
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="mb-3 pe-5 ps-5">
                  ...
                  <input type="text" class="form-control" id="id_ahli" name="id_ahli" value="<?php echo $user_data['nama_ahli']; ?>" disabled>
                </div>
